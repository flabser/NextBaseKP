        ...
        <html>
            <head>
                ...
                <style>
                    ...
                    .printcoord  #docwrapper div.formwrapper div#tabs div#tabs-3 div#printCoordTitle{
                    display:block !important;
                    }
                    .printdocument  #docwrapper div.formwrapper div#tabs div#tabs-3 div#printCoordTitle{
                                        ...
                                        <tr>
                                            <td class="fc">
                                                <font style="vertical-align:top">
                                                    <xsl:value-of select="$captions/corr/@caption"/> :
                                                </font>
                                                <xsl:if test="$editmode = 'edit'">
                                                    <a>
                                                        <xsl:attribute name="href">javascript:dialogBoxStructure('admdepemployers','true','coordblock','frm', 'coordblocktbl');</xsl:attribute>
                                            ...
                                            <td>
                                                <xsl:if test="document/@status='new'">
                                                    <table id="coordblocktbl" style="border-spacing:0px 3px;">
                                                        <tr>
                                                        ...
                                                        <xsl:for-each select="$fields/coordination/blocks/entry[type!='TO_SIGN']">
                                                            <tr>
                                                                <td class="td_editable" style="width:600px;">
                                                                    ...
                                                                    <xsl:value-of select="coordinators/entry/employer/fullname"/>&#xA0;
                                                                </td>
                                                            </tr>
                                                        </xsl:for-each>
                                                    </table>
                                                ...
                                                <input type="hidden" id="coordblockcaption" value="{$captions/corr/@caption}"/>
                                                <script>
