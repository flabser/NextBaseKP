							...
							<form action="Provider" name="frm" method="post" id="frm" enctype="application/x-www-form-urlencoded">
									...
									<table width="100%" border="0">
										...
										<xsl:if test="$status != 'new'">
											<tr>
												...
												<td>
													<input size="53" type="text" value="{document/fields/signer}"
														   id="signer" onfocus="javascript:$(this).blur()"
														   class="td_noteditable" readonly="readonly"
														   style="width:600px;"/>
										...
										<tr>
											...
											<td>
												<div>						
													<textarea name="briefcontent" style="width:748px;" rows="3" class="textarea_editable">
														<xsl:if test="$editmode !='edit'">
										...
										<tr>
											...
											<td>
												<input type="text" value="{substring(document/fields/ctrldate,1,10)}" name="ctrldate" readonly="readonly" class="td_editable" onfocus="javascript: $(this).blur()" style="background:#eee; width:80px; padding:3px 3px 3px 5px; border:1px solid #eee; vertical-align:top">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="class">textarea_noteditable</xsl:attribute>
													</xsl:if>
													<xsl:if test="$editmode = 'edit'">
								...
								<div id="tabs-2" style="height:500px">
									...
									<table width="100%" border="0">
										...
										<tr>
											<td class="fc"><xsl:value-of select="document/captions/contentsource/@caption"/> :</td>
											<td>
												<script type="text/javascript">
								...
								<xsl:if test="$status = 'new'">
									<input type="hidden" name="recipient" value="{document/fields/recipient/@attrval}"/>
								</xsl:if>
								<input type="hidden" name="type" value="save"/>
								<input type="hidden" name="id" value="workdocdept"/>
