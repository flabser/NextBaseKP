...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/request[@id !='signers'][@id !='workdocsigners'][@id!='admdepemployers'][@id!='coordinatorsworkdocdept'][@id!='recipientworkdocdept']/query/entry/viewtext"/>
	<xsl:template match="/request[@id !='signers'][@id !='workdocsigners'][@id!='admdepemployers'][@id!='coordinatorsworkdocdept'][@id!='recipientworkdocdept']/query/entry/responses">
		...
		<xsl:template match="/request[@id='recipientworkdocdept']/query">
			<xsl:if test="../@id = 'recipientworkdocdept'">
				<xsl:for-each select="descendant::entry">
					<xsl:sort select="viewcontent/viewtext1"/>
					<xsl:if test="@doctype = 889  and viewcontent/viewtext2 != '-1'">
						<div style="display:block; width:100%; cursor:pointer; text-align:left" name="itemStruct">
